...
return [
    ...
    'info' => [
         ...
         */
        'description' => <<<'MD'
IMBY product JSON API for planning warehouse data (`imby_data_v2`).

**Auth:** Sanctum bearer tokens from `POST /auth/login` or `/auth/register`. Pass `Authorization: Bearer <token>`.
